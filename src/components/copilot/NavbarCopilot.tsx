...
export const NavbarCopilot: React.FC = () => {
  ...
  const handleNavCtaClick = () => {
    trackCheckoutClick('nav_cta_copilot', 'Navbar Copilot - DAPATKAN + BONUS GPT CO-PILOT — Rp97.000');
  };

  return (
    <nav
      id="main-navbar-copilot"
    ...
    >
      <div className="w-full max-w-[480px] px-3.5">
        <div className="flex justify-between items-center h-11 gap-2">
          ...
          <a href="#" className="flex items-center gap-2 group shrink-0 min-w-0">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold text-blue-900 tracking-tight mt-0.5 flex items-center gap-1">
                <span>+ Bonus GPT Co-Pilot ISO 19011</span>
              </span>
            </div>
          </a>
        ...
        {mobileMenuOpen && (
          <div className="mt-2 pt-3 pb-4 border-t border-gray-200 bg-white rounded-2xl shadow-xl px-4 space-y-2.5 text-sm font-semibold">
            <a
              href="#alur-kerja-praktik"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2 text-gray-800 hover:text-blue-900"
            >
              🔄 Sistem Praktik Audit (Workflow)
            </a>
            <a
              href="#bonus-gpt-copilot"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2 text-amber-800 hover:text-amber-950 font-bold"
            >
              🎁 Bonus: GPT Co-Pilot ISO 19011:2026
            </a>
            <a
              href="#semua-yang-didapatkan"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2 text-gray-800 hover:text-blue-900"
            >
            ...
            <a
              ...
              className="block py-2 text-gray-800 hover:text-blue-900"
            >
              💬 Pengalaman Pengguna (Testimoni)
            </a>
            <a
              href="#penawaran-harga-copilot"
              onClick={() => setMobileMenuOpen(false)}
              className="block py-2 text-gray-800 hover:text-blue-900"
            >
              🏷️ Penawaran Spesial Rp97.000
            </a>
            <a
              href="#faq-section"
              onClick={() => setMobileMenuOpen(false)}
            ...
            <div className="pt-2">
              <a
                ...
                className="w-full text-center flex items-center justify-center gap-1.5 bg-gradient-to-r from-red-600 to-rose-700 hover:from-red-700 text-white py-3.5 rounded-xl font-black text-xs sm:text-sm shadow-md"
              >
                <span>DAPATKAN SMART AUDIT + BONUS GPT CO-PILOT</span>
              </a>
            </div>
          </div>
        )}
