      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
        ...
        <div className="max-w-xl mx-auto bg-black/30 border border-white/15 rounded-2xl p-5 mb-8 backdrop-blur-sm">
          ...
          <p className="text-amber-200 text-xs sm:text-sm font-medium leading-relaxed">
            *Promo September Ceria: Saat ini <strong className="text-white">Rp97.000</strong>, akan kembali ke Harga Normal (<strong className="text-white">Rp249.000</strong>). Amankan harga promo terendah hari ini!
          </p>
        </div>
